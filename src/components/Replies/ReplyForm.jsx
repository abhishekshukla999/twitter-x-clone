    ...
    return (
        <div className="reply-form flex pt-3 w-full max-h-[70%] border-b border-zinc-200 dark:border-gray-800 dim:border-gray-800">
            ...
            <form className="items w-[90%]" onSubmit={handleSubmit(submitPost)}>
                ...
                <div className="">
                    <textarea
                        className="w-full max-h-[60vh] dark:bg-twitter-lightsout-bg dim:bg-twitter-dim-bg dark: overflow-y-auto text-xl focus:outline-none  whitespace-normal p-2 resize-none"
                        type="text"
                        rows="4"
