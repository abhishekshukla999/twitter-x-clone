...
function MessagesList() {
    ...
    return (
        <div className="flex flex-col xl:flex-[0_0_34%] max-[1553px]:flex-[0_0_55%] border-b-0 border-t-0 h-screen">
            ...
            <div className="flex px-2 py-2 hover:bg-gray-100 text-base border-r border-l">
                <div className="m-2 p-3 border rounded-full bg-white ">
                    <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        className="w-6 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-1472mwg r-lrsllp r-18jsvk2"
                    >
                        <g>
                ...
                <div className="my-2 p-3 font-[400] text-zinc-500">
                    Message requests
                </div>
            </div>

            {!mess ? (
                <div className="border-l border-r h-screen">
