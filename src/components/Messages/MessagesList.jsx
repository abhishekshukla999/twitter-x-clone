...
import { MobileNavIcon, SearchBox, ChatItem } from "../index";

function MessagesList() {
    const mess = true;

    return (
        <div className="flex flex-col xl:flex-[0_0_35%] lg:flex-[0_0_37%] max-[1004px]:flex-[0_0_80%] max-[704px]:flex-[0_0_100%] border-b-0 border-t-0 h-screen dark:border-gray-800 dim:border-gray-800">
            ...
            {!mess ? (
                ...
                <div className="flex flex-col">
                    ...
                    <ChatItem />
                    <ChatItem />
                    <div className="font-[500] text-lg text-center p-2 border-l border-r dark:border-gray-800 dim:border-gray-800 h-screen">
                        This feature is under development and will be released
                        in future updates.
                    </div>
                </div>
            )}
