        ...
        <>
            <div className="whatshapp flex pt-3 w-full min-h-fit border border-t-0 border-zinc-200">
                ...
                <div className="items w-[90%]">
                    ...
                    <div className="mx-5">
                        <textarea
                            className="w-full max-h-fit text-xl focus:outline-none overflow-hidden whitespace-normal p-2 resize-none"
                            type="text"
                    ...
                    <div className="flex justify-between border border-b-0 border-l-0 border-r-0">
                        <ul className="flex my-2">
                            <li className="mx-2">
                                <svg
                                    viewBox="0 0 24 24"
                                    aria-hidden="true"
                                    className="w-5 fill-blue-500 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-z80fyv r-19wmn03"
                                >
                                    <g>
                        ...
                        <div className="my-2">
                            <button className="w-28 mx-2 text-base text-white bg-twitter-blue hover:bg-blue-600 rounded-full">
