        ...
        <>
            <div className="tweet-form flex max-[499px]:hidden pt-3 w-full max-h-[70%] border border-t-0 border-zinc-200 dark:border-gray-800 dim:border-gray-800">
                ...
                >
                    ...
                    <div className="">
                        <textarea
                            className="w-full max-h-[60vh] overflow-y-auto text-xl focus:outline-none whitespace-normal p-2 resize-none dark:bg-twitter-lightsout-bg dim:bg-twitter-dim-bg"
                            type="text"
                            rows="4"
                    ...
                    <div className="flex justify-between border-t dark:border-gray-800 dim:border-gray-800">
                        <div className="flex my-2 flex-wrap">
                            {/* file upload */}
                            <div
                                className="mx-0.5 p-2 w-fit h-fit hover:bg-blue-100 yellow:hover:bg-yellow-100 crimson:hover:bg-rose-100 purple:hover:bg-purple-300 orange:hover:bg-orange-300 green:hover:bg-green-300 rounded-full"
                                title="media"
                            >
                        ...
                        <div className="my-2">
                            <button
                                type="submit"
                                className={`w-20 mx-2 py-2 font-bold text-base text-white ${
                                    !buttonDisabled
