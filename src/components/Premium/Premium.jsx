        ...
        <div className="overflow-y-auto h-screen">
            ...
            <div>
                ...
                >
                    ...
                    <div>
                        <div className="p-2">
                            <span className="text-3xl font-bold">₹215.87</span>
                            <span>/month</span>
                        </div>
                ...
                >
                    ...
                    <div>
                        <div className="p-2">
                            <span className="text-3xl font-bold">₹566.67</span>
                            <span>/month</span>
                        </div>
                        <div className="text-sm p-2">
                ...
                >
                    ...
                    <div>
                        <div className="p-2">
                            <span className="text-3xl font-bold">₹1,133.3</span>
                            <span>/month</span>
                        </div>
                        <div className="text-sm p-2">
                ...
                <div className="m-6 p-4 flex gap-1 flex-col justify-center items-center">
                    ...
                    <button
                        type="submit"
                        className="font-bold mx-2 w-[70%] p-1 rounded-full text-white bg-twitter-blue"
