...
function PostModal({ isOpen, onClose, post = false }) {
    ...
    return createPortal(
        ...
        >
            ...
            <div
                className="bg-white overflow-y-auto opacity-100 p-5 rounded-xl shadow-lg relative 2xl:w-[50%] xl:w-[60%] lg:w-[50%] md:w-[60%] max-h-fit max-[702px]:h-screen max-[702px]:w-screen text-black"
                        ...
                        >
                            ...
                            <div className="flex justify-between border border-b-0 border-l-0 border-r-0">
                                <div className="flex my-2 flex-wrap">
                                    {/* file upload */}
                                    <div
                                        className="mx-0.5 p-2 w-fit h-fit rounded-full cursor-pointer hover:bg-blue-100"
                                        title="media"
                                    >
                                        <label
                                    ...
                                    {/* gif */}
                                    <div
                                        className="mx-0.5 p-2 cursor-not-allowed w-fit h-fit hover:bg-red-200 rounded-full"
                                        title="GIF"
                                    >
                                        <svg
                                            viewBox="0 0 24 24"
                                            aria-hidden="true"
                                            className="w-5 fill-blue-500 cursor-not-allowed r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-z80fyv r-19wmn03"
                                        >
                                            <g>
