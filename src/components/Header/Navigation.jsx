...
function Navigation() {
    const listStyle =
        "flex p-3 text-xl hover:bg-zinc-200 dark:hover:bg-slate-500 dim:hover:bg-slate-500 rounded-full w-fit";
    ...
    return (
        <nav className="first">
            <div className="logo p-4 hover:bg-zinc-200 dark:hover:bg-slate-800 dim:hover:bg-slate-700 rounded-full w-fit">
                <NavLink to="/home">
                    <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        className="w-8 dark:invert dim:invert r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-lrsllp r-18jsvk2 r-16y2uox r-8kz0gk"
                    >
                        <g>
            ...
            {/* Side Menu for MD Screen */}
            <NavigationMD />

            <div className="post-button xl:my-4 max-xl:m-2" title="Posts">
                <button className="w-60 text-xl text-white font-bold bg-twitter-blue rounded-full hover:bg-sky-600 yellow:bg-twitter-yellow yellow:hover:bg-yellow-600 crimson:bg-twitter-crimson crimson:hover:bg-rose-600 purple:bg-twitter-purple purple:hover:bg-purple-600 orange:bg-twitter-orange orange:hover:bg-orange-600 green:bg-twitter-green green:hover:bg-green-600 hidden xl:block">
                    <div className="p-3" onClick={() => setIsOpen(true)}>
                        Post
                    </div>
                </button>
                <button
                    className="bg-twitter-blue p-3 w-[50px] rounded-full hover:bg-sky-600 yellow:bg-twitter-yellow yellow:hover:bg-yellow-600 crimson:bg-twitter-crimson crimson:hover:bg-rose-600 purple:bg-twitter-purple purple:hover:bg-purple-600 orange:bg-twitter-orange orange:hover:bg-orange-600 green:bg-twitter-green green:hover:bg-green-600 hidden max-xl:block"
