...
function SideMenuMD() {
    const listStyle = "flex p-3 text-xl hover:bg-zinc-200 dark:hover:bg-slate-800 dim:hover:bg-slate-700 rounded-full w-fit";
            ...
            <ul className="">
                <li className="p-1">
                    <NavLink
                        to="/home"
                        className={({ isActive }) =>
                            `${listStyle} ${isActive ? "bg-gray-200 dark:bg-slate-800 dim:bg-slate-700" : null}`
                        }
                        title="Home"
                    >
                        <span className="mx-1">
