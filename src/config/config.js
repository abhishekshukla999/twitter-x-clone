export const config = {
    ...
    appwriteTweetsCollectionId: String(
        import.meta.env.VITE_APPWRITE_TWEETS_COLLECTION_ID
    ),
    ...
    appwriteTweetsBucketId: String(
        import.meta.env.VITE_APPWRITE_TWEETS_BUCKET_ID
    ),
};
